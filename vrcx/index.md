...
![言語設置の場所](images/15_i18n.png)

最初の画面はこんな感じです、明るいね。左下に **"管理"** → **"テーマ"** に切り替えできます。
...
次は **通知** 設定。デスクトップも通知を見えるように、

**"デスクトップでの通知の表示"** に、**"デスクトップモード"**

と

**"AFK 中でもデスクトップに通知"**　を設置。

設置終わったら、一番大事な　**"通知フィルター"**　いじります。

![通知の設定](images/10_notiSettings.png)
...
みんなー　共通フレンドオンにしましょうよ～♡

![monitoring](images/16_mutualFriends.png)

（やったらわかると思う）

## 写真を見るとき、あれ、この人だれ？

25年5月以降、保存されたすべての写真とプリントには、以下を含む一部のメタデータが含まれるようになります。

| メタデータ | 例 |
| - | - |
|ワールド、インスタンスの情報 | VRChat Home · フレンド+
| 撮影者 | player1
|プレイヤーリスト | player1, player2
|基本的なタイムスタンプ | 07/21/2077, 11:45:14

**"ツール"** →　**スクリーンショットの管理**

![スクリーンショットの管理ツール](images/17_picsManager.png)

この画面に**写真をドラッグ＆ドロップ**すると、そのメタデータを確認できます。

![うんち](images/18_metadataView.png)


## おわり

* SteamVRオーバーレイの通知くるのは遅い、どうしよう？
  * XSOverlay買ってください。全部解決できるから。
  * ガチでいいもの（本音
